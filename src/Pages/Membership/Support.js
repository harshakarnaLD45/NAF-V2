...
const Support = () => {
    ...
    const handleSubmit = async () => {
        ...
        const fields = [
            { label: "Full Name", value: formTab0.fullName },
            { label: "Email", value: formTab0.email },
            { label: "Phone", value: formTab0.phoneNumber },
            { label: "Machine ID / Location", value: formTab0.machineIdLocation },
            { label: "Account Type", value: formTab0.accountType },
            { label: "Request Type", value: formTab0.requestType },
            { label: "Subject", value: formTab0.subject },
            { label: "Message", value: formTab0.message },
        ];
        ...
        <tbody>
          ${fields
                .map(
                    (f) => `
              <tr>
                <td style="border:1px solid #ddd; padding:8px; font-weight:bold; width:30%;">
                  ${f.label}
                </td>
    ...
    return (
        ...
        >
            ...
            <Box sx={{ mt: { xs: 13, sm: 13, md: 13, lg: 20, xl: 25 },}}>
                <Box
                    sx={{
                        width: "100%",
                    }}
            ...
            {/* FAQ Section */}
            <Box sx={{  mt: {xs: 13, sm: 13, md: 13, lg: 20, xl: 25 },  width: '100%' }}>
