    ...
    <>
      <Box >
          ...
          <Box className='solutions-hero-sec'
            sx={{
              ...
              background: {
                ...
                xs: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${cloudKitchenPayments}) lightgray 100% / cover no-repeat`,
                sm: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${cloudKitchenPayments}) lightgray 100% / cover no-repeat`,
                md: `linear-gradient( 270deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37%), url(${cloudKitchenPayments}) lightgray 50% / cover no-repeat`
              },
              // objectFit: 'contain',
            }}
          >
        ...
        >
          ...
          {/* Industry compliance*/}
          <Box sx={{ display: 'flex', flexDirection: 'column', mt: { xs: 14,sm:25, md: 35 }, }}>
            <Typography sx={{ color: '#fcfcfc' }} className='headings-h3'>
          ...
          <Box id="contact" sx={{ mt: { xs: 8, md: 35 }, display:'flex', justifySelf:'center',alignContent:'center'  }}>
            <SolutionProductForm />
          </Box>
