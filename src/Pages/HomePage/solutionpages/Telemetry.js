          ...
          <Box
            ...
            sx={{
              ...
              background: {
                ...
                xs: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${TelemetryMonitoring}) lightgray 100% / cover no-repeat`,
                sm: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${TelemetryMonitoring}) lightgray 100% / cover no-repeat`,
                md: `linear-gradient( 270deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37%), url(${TelemetryMonitoring}) lightgray 50% / cover no-repeat`
              },
              // objectFit: 'contain',
            }}
          >
