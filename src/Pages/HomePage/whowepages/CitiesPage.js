...
const CitiesPage = () => {
  ...
  return (
    <>
        ...
        <Box
          sx={{
            ...
            background: {
              ...
              xs: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${cityImg}) lightgray 100% / cover no-repeat`,
              sm: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${cityImg}) lightgray 100% / cover no-repeat`,
              md: `linear-gradient( 270deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37%), url(${cityImg}) lightgray 50% / cover no-repeat`
            },
            // objectFit: 'contain',
          }}
        >
          <Box sx={{  width: { xs: '100%', sm: '70%', md: '45%' } }}>
            ...
            <Box sx={{ mt: 4,  display: { xs: 'none', sm: 'none', md: 'flex' }, justifyContent: { xs: 'flex-start', md: 'flex-start' } }}>
      ...
      {/* CONTENT */}
      <Box sx={{ mt: { xs: 8, md: 10 }, px: { xs: 2, sm: 2 }, py: 6 }}>
        <Typography className="bodyRegularText3" sx={{ color: '#c2c2c4' }}>
      ...
      <Box sx={{  mt: { xs: 8, md: 25 }, mb: 8 }}>
        ...
        {/* MACHINES */}
        <Box sx={{  px: { xs: 2, sm: 6 }, mt: { xs: 14,sm:16, md: 35 }, mb: 8 }}>
      ...
      {/* FAQ */}
      <Box sx={{ mt: { xs: 10, md: 25 }, py: { xs: 6, md: 8 },  p: { xs: 1.5, sm: 4, md: 6 },  width: '100%',boxSizing:'border-box',overflow:'hidden'  }}>
        ...
        <Box sx={{ width: { xs: '86%', sm: '80%', md: '60%', lg: '40%' }, mx: 'auto' }}>
