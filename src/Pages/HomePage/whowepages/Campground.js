...
const CampGrounds = () => {
  ...
  return (
    <>
      ...
      <Box sx={{ mt: { xs: 8, md: 16 }, width: '100%' }}>
        <Box
          sx={{
            ...
            overflow: 'hidden',
            background: {
              xs: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${camp}) lightgray 100% / cover no-repeat`,
              sm: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${camp}) lightgray 100% / cover no-repeat`,
              md: `linear-gradient( 270deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37%), url(${camp}) lightgray 50% / cover no-repeat`
            },
          }}
        >
      ...
      {/* CONTENT SECTION */}
      <Box sx={{ mt: { xs: 8, md: 10 }, p: { xs: 1.5, sm: 4, md: 6 }, }}>
        <Typography className="bodyRegularText3" sx={{ color: '#c2c2c4' }}>
      ...
      <Box sx={{ mt: { xs: 10, md: 25 }, py: { xs: 6, md: 8 },
       p: { xs: 1.5, sm: 4, md: 6 },  width: '100%',boxSizing:'border-box',
       overflow:'hidden'  }}>
