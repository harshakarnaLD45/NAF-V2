  ...
  return (
    <>
        ...
        <Box
          sx={{
            ...
            background: {
              ...
              xs: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${clinic}) lightgray 100% / cover no-repeat`,
              sm: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${clinic}) lightgray 100% / cover no-repeat`,
              md: `linear-gradient( 270deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37%), url(${clinic}) lightgray 50% / cover no-repeat`
            },
            // objectFit: 'contain',
          }}
        >
      ...
      <Box sx={{  mt: { xs: 8, md: 25 }, mb: 8 }}>
        ...
        {/* Machines Section */}
        <Box sx={{ px: { xs: 2, sm: 6 },  mt: { xs: 14, sm: 16, md: 35 }, mb: 4 }}>
