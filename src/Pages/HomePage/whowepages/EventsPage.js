  ...
  return (
    <>
      ...
      <Box sx={{ mt: { xs: 8, md: 16 }, width: '100%', boxSizing: 'border-box' }}>
        <Box
          sx={{
            ...
            overflow: 'hidden',
            background: {
              xs: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${events}) lightgray 100% / cover no-repeat`,
              sm: `linear-gradient( 180deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37% ), url(${events}) lightgray 100% / cover no-repeat`,
              md: `linear-gradient( 270deg, rgba(0, 0, 0, 0.00) 32.78%, rgba(0, 0, 0, 0.50) 62.37%), url(${events}) lightgray 50% / cover no-repeat`
            },
          }}
        >
      ...
      <Box sx={{mt: { xs: 8, md: 25 }, mb: 8 }}>
        ...
        {/* MACHINES */}
        <Box sx={{  px: { xs: 2, sm: 6 },  mt: { xs: 14, sm: 16, md: 35 }, }}>
      ...
      {/* FAQ */}
      <Box sx={{ mt: { xs: 10, md: 25 }, py: { xs: 6, md: 8 },  p: { xs: 1.5, sm: 4, md: 6 },  width: '100%',boxSizing:'border-box',
       overflow:'hidden'}}>
