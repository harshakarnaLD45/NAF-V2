...
import TradefairPopupimg from  '../../assets/Home/TradefairPopupImg.png';
    ...
    <Box className="tradefair-popup-overlay">
      <Box className="tradefair-popup-container">
        ...
        <Box className="tradefair-popup-content">
          <img src={TradefairPopupimg} alt="calendar"   style={{marginTop: '8px', width: '100%',height: 'auto',borderRadius: '20px',maxHeight: '260px',
